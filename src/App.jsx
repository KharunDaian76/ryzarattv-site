...
const games = [
  {
    ...
    type: "Hero Shooter",
    note: "Competitive",
    image: `${baseUrl}images/games/overwatch.jpg`,
  },
  {
    name: "Counter-Strike 2",
    type: "Tactical FPS",
    note: "Ranked",
    image: `${baseUrl}images/games/cs2.jpg`,
  },
  {
    name: "VALORANT",
    type: "Tactical Shooter",
    note: "Competitive",
    image: `${baseUrl}images/games/valorant.jpg`,
  },
  {
    name: "Where Winds Meet",
    type: "Open-World RPG",
    note: "Adventure",
    image: `${baseUrl}images/games/where-winds-meet.jpg`,
  },
  {
    name: "Steam Library",
    type: "Variety",
    note: "Whatever feels fun",
    image: `${baseUrl}images/games/steam.jpg`,
  },
];
